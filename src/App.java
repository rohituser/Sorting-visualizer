...
public class App extends JFrame implements ActionListener {
    ...
    public App(){
        ...
        // Add Name
        name = new JLabel("Rohit Vishwakarma");
        ...
        sortingName = new JLabel("Sorting");
        ...
        sortingName.setBounds(400,80,206,40);
        sortingName.setFont(new Font("Niagara Solid", Font.BOLD, 14));
        sortingName.setForeground(Color.BLACK);
//        panelUpper.add(sortingName);
